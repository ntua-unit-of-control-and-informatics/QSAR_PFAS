...
if __name__ == "__main__":
    ...
    selected_features = ["Bit_1422", "Bit_1720", "MinEStateIndex", "Bit_486"]
    ...
    if len(filtered_halflife_stats) == 0:
        ...
        plt.savefig(
            "PFAS_HalfLife_QSAR/ED_GPR/Revamped_dataset/pfas_halflife_predictions_test.png",
            dpi=300,
        )
        plt.show()
    else:
        ...
        # Save the plot
        plt.savefig(
            "PFAS_HalfLife_QSAR/ED_GPR/Revamped_dataset/pfas_halflife_predictions_test_only.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.show()
        ...
        data_to_plot.to_csv(
            "PFAS_HalfLife_QSAR/ED_GPR/Revamped_dataset/pfas_halflife_test_stats_predictions.csv",
            index=False,
        )
